...
data3b = function(){
  ...
  for(t in 1:100){
    ...
    nonzero = c(T,F,T,T,F,T,T,F,T,T,F,T,T,F,T,rep(FALSE,15))
    ...
    #case 3(b)
    beta32=c(1,0,-1,-1,0,1)
    beta3b=c(-1,0,1,1,0,-1,-1,0,1,beta32,rep(0,15))
    y3b1 = 4*x3%*%beta3b+error1
    y3b2 = 4*x3%*%beta3b+error2
    x = x3
    y1 = y3b1
    y2 = y3b2
    ...
    P_1_50_0.1[t] = sum(nonzero&(c(m$loadings.B%*%m$gamma)!=0))/10
    N_1_50_0.1[t] = sum(!nonzero&(c(m$loadings.B%*%m$gamma)==0))/20
    ...
    AP_1_50_0.1[t] = sum(nonzero&(c(m$loadings.B%*%m$gamma)!=0))/10
    AN_1_50_0.1[t] = sum(!nonzero&(c(m$loadings.B%*%m$gamma)==0))/20
    ...
    P_1_200_0.1[t] = sum(nonzero&(c(m$loadings.B%*%m$gamma)!=0))/10
    N_1_200_0.1[t] = sum(!nonzero&(c(m$loadings.B%*%m$gamma)==0))/20
    ...
    AP_1_200_0.1[t] = sum(nonzero&(c(m$loadings.B%*%m$gamma)!=0))/10
    AN_1_200_0.1[t] = sum(!nonzero&(c(m$loadings.B%*%m$gamma)==0))/20
    ...
    P_10_50_0.1[t] = sum(nonzero&(c(m$loadings.B%*%m$gamma)!=0))/10
    N_10_50_0.1[t] = sum(!nonzero&(c(m$loadings.B%*%m$gamma)==0))/20
    ...
    AP_10_50_0.1[t] = sum(nonzero&(c(m$loadings.B%*%m$gamma)!=0))/10
    AN_10_50_0.1[t] = sum(!nonzero&(c(m$loadings.B%*%m$gamma)==0))/20
    ...
    P_10_200_0.1[t] = sum(nonzero&(c(m$loadings.B%*%m$gamma)!=0))/10
    N_10_200_0.1[t] = sum(!nonzero&(c(m$loadings.B%*%m$gamma)==0))/20
    ...
    AP_10_200_0.1[t] = sum(nonzero&(c(m$loadings.B%*%m$gamma)!=0))/10
    AN_10_200_0.1[t] = sum(!nonzero&(c(m$loadings.B%*%m$gamma)==0))/20
    ...
    P_1_50_1[t] = sum(nonzero&(c(m$loadings.B%*%m$gamma)!=0))/10
    N_1_50_1[t] = sum(!nonzero&(c(m$loadings.B%*%m$gamma)==0))/20
    ...
    AP_1_50_1[t] = sum(nonzero&(c(m$loadings.B%*%m$gamma)!=0))/10
    AN_1_50_1[t] = sum(!nonzero&(c(m$loadings.B%*%m$gamma)==0))/20
    ...
    P_1_200_1[t] = sum(nonzero&(c(m$loadings.B%*%m$gamma)!=0))/10
    N_1_200_1[t] = sum(!nonzero&(c(m$loadings.B%*%m$gamma)==0))/20
    ...
    AP_1_200_1[t] = sum(nonzero&(c(m$loadings.B%*%m$gamma)!=0))/10
    AN_1_200_1[t] = sum(!nonzero&(c(m$loadings.B%*%m$gamma)==0))/20
    ...
    P_10_50_1[t] = sum(nonzero&(c(m$loadings.B%*%m$gamma)!=0))/10
    N_10_50_1[t] = sum(!nonzero&(c(m$loadings.B%*%m$gamma)==0))/20
    ...
    AP_10_50_1[t] = sum(nonzero&(c(m$loadings.B%*%m$gamma)!=0))/10
    AN_10_50_1[t] = sum(!nonzero&(c(m$loadings.B%*%m$gamma)==0))/20
    ...
    P_10_200_1[t] = sum(nonzero&(c(m$loadings.B%*%m$gamma)!=0))/10
    N_10_200_1[t] = sum(!nonzero&(c(m$loadings.B%*%m$gamma)==0))/20
    ...
    AP_10_200_1[t] = sum(nonzero&(c(m$loadings.B%*%m$gamma)!=0))/10
    AN_10_200_1[t] = sum(!nonzero&(c(m$loadings.B%*%m$gamma)==0))/20
  }
